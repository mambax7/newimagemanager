 ...
 * @package     system
 * @version     $Id: main.php 4091 2010-01-05 17:02:11Z forxoops $
 */
$xoopsPreload =& XoopsPreload::getInstance();
$xoopsPreload->triggerEvent('core.admin.images.main.start');
...
switch ( $op ) {
    ...
    case 'list':
        ...
        //$xoBreadCrumb->addLink( _AM_SYSTEM_IMAGES_MAIN );
        ...
        if ( in_array( XOOPS_GROUP_ADMIN, $groups ) ) {
            ...
            $storetype = new XoopsFormRadio( '<div class="spacer">' . _AM_SYSTEM_IMAGES_IMGCATSTRTYPE . '</div><span class="red">' . _AM_SYSTEM_IMAGES_STRTYOPENG . '</span>', 'imgcat_storetype', 'file');
            $storetype->addOptionArray( array( 'file' => _AM_SYSTEM_IMAGES_ASFILE, 'db' => _AM_SYSTEM_IMAGES_INDB ) );
    ...
    case 'listimg':
		...
		$xoTheme->addScript('browse.php?modules/system/js/admin.js');
		$xoTheme->addScript('browse.php?modules/system/js/lightbox.js');
        ...
        $criteria->setLimit($xoopsModuleConfig['images_pager']);
        ...
        if ($imgcount > 0) {
            if ($imgcount > 20) {
                ...
                $nav = new XoopsPageNav($imgcount, $xoopsModuleConfig['images_pager'], $start, 'start', 'fct=images&amp;op=listimg&amp;imgcat_id='.$imgcat_id);
    ...
    case 'editimg':
        ...
        if ( $image_id > 0 ) {
            ...
            $msg = '<div class="txtcenter"><img src="./class/thumbs/phpThumb.php?src=' . XOOPS_UPLOAD_URL . '/' . $image->getVar('image_name') . '&amp;h=120" alt="" /></div>';
    ...
    case 'delfile':
        ...
        // Define scripts
		$xoTheme->addScript('browse.php?Frameworks/jquery/jquery.js');
		$xoTheme->addScript('browse.php?Frameworks/jquery/plugins/jquery.thumbs.js');
