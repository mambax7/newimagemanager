...
$xoops_root_path = substr($current_path, 0, strpos(strtolower($current_path), "/modules/newimagemanager/libs/imageeditor"));
// get xoops rooth path - end

require_once($xoops_root_path . '/modules/newimagemanager/libs/wideimage/lib/WideImage.php');

$rel_path = $xoops_root_path . "/uploads/newimagemanager/imageeditor";

$originalDirectory = $rel_path."/original/";
$activeDirectory = $rel_path."/active/";
$editDirectory = $rel_path."/edit/";
$undoDirectory = $rel_path."/undo/";
$imageName = $_REQUEST["imageName"];
$action = $_REQUEST["action"];
