...
ImageEditor.processImage = function(args){
	...
	request.open("POST", "../libs/imageeditor/processImage.php", true);
...
ImageEditor.loadImage = function(){
	ImageEditor.loaderImage.setAttribute("src", "../libs/imageeditor/getImage.php?imageName=" + ImageEditor.imageName + "&t=" + (new Date).getTime());
};
...
ImageEditor.mirror = function(){
	ImageEditor.processImage("action=mirror");
};
ImageEditor.flip = function(){
	ImageEditor.processImage("action=flip");
};
...
ImageEditor.brightnessinc = function(){
    ImageEditor.processImage("action=brightness&amt=20");
};
ImageEditor.brightnessdec = function(){
    ImageEditor.processImage("action=brightness&amt=-20");
};
ImageEditor.contrastinc = function(){
    ImageEditor.processImage("action=contrast&amt=20");
};
ImageEditor.contrastdec = function(){
    ImageEditor.processImage("action=contrast&amt=-20");
};
ImageEditor.colorize = function(color_red, color_green, color_blue){
    ImageEditor.processImage("action=colorize&color_red=" + color_red + "&color_green=" + color_green + "&color_blue=" + color_blue);
};
ImageEditor.hue = function(color_red, color_green, color_blue){
    ImageEditor.processImage("action=hue&color_red=" + color_red + "&color_green=" + color_green + "&color_blue=" + color_blue);
};
...
ImageEditor.init = function(imageName,image_id){

    ImageEditor.imageName = imageName || "";
    ImageEditor.editorImage = document.getElementById(image_id);
